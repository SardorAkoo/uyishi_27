...
import 'package:uyishi_27/main_2.dart';

class ob_havo extends StatelessWidget {
  const ob_havo({super.key});
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: Colors.blue,
                          border:
                              Border.all(color: Colors.white), // Sınır eklemek
                          // Düzeltme
                        ),
                        child: Row(
                          children: [
